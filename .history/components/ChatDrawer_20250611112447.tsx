      ...
      {open && (
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-4">
            <div className="text-center text-muted-foreground bg-gray-50 p-6 rounded-lg">
              <h3 className="text-lg font-medium mb-4">内容已清空</h3>
              <p className="text-sm">所有示例内容已删除</p>
              <p className="text-xs mt-2">UI框架保留，等待功能开发</p>
            </div>
          </div>
        </motion.div>
      )}
