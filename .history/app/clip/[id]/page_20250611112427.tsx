                    ...
                    >
                      ...
                      <button
                        onClick={() => {
                          ...
                          try {
                            // 解码URL编码的锚点
                            const decodedAnchor = decodeURIComponent(section.anchor);
                            // 移除#号，使用CSS转义函数处理特殊字符
                            ...
                            const element = document.getElementById(anchorId) || 
                                          ...
                                          Array.from(document.querySelectorAll('h1, h2, h3, h4, h5, h6'))
                                               .find(el => el.textContent?.includes(section.title));
                            if (element) {
                              element.scrollIntoView({ behavior: 'smooth' });
                            } else {
                              console.warn('未找到章节元素:', section.title, section.anchor);
                            }
                          } catch (error) {
